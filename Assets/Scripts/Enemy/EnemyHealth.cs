...
public class EnemyHealth : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            gameManagerGameObject = GameObject.FindWithTag("GameManager");
    ...
    public void TakeDamage(float damage)
    {
        ...
        if((name == "EnemyBoss1" || name == "EnemyBoss2" || name == "EnemyBoss3" || name == "EnemyBoss4")  && currentHealth < 0)
        {
            gameObject.SetActive(false);
            
            if(name == "EnemyBoss2")
            {
                gameManager.UnlockOccultist();
            }

            if(name == "EnemyBoss4")
            {
                gameManager.UnlockDruid();
                gameManager.GameWin();
            }
