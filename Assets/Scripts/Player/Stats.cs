...
public class Stats : MonoBehaviour
{
    ...
    public void UpdateUGUI()
    {
        ...
        criticalChanceText.text = criticalChance.ToString("0") +"%";
        ...
        specialCooldownText.text = specialAttackCooldown.ToString("0.00");

        hitInvulnerabilityText.text = hitInvulnerability.ToString("0.00");

        dashRangeText.text = dashRange.ToString("0.00");

        dashCooldownText.text = dashCooldown.ToString("0.00");
